...
train_cfg = dict(
    rpn=dict(
        ...
        sampler=dict(
            type='RandomSampler',
            num=256,
            pos_fraction=0.5,            #num_pos : num_neg
            neg_pos_ub=-1,
...
data_root = '/nas/datasets/dota1-split-1024/'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_RoITrans_r101_fpn_dea'

#result out dir
# work_dir = './work_dirs/RoITransFcos_r101_debug'
