...
from HRSC2COCO import HRSC2COCOTrain, HRSC2COCOTest
import argparse
...
def parse_args():
    parser = argparse.ArgumentParser(description='prepare HRSC2016')
    parser.add_argument('--srcpath', default='/home/AerialDetection/data/HRSC2016')
    parser.add_argument('--dstpath', default=r'/home/AerialDetection/data/HRSC2016_split',
                        help='prepare data')
...
def prepare(srcpath, dstpath):
    ...
    HRSC2COCOTrain(os.path.join(dstpath, 'trainval1024'), os.path.join(dstpath, 'trainval1024', 'HRSC_trainval1024.json'), wordname_15, difficult='-1')
    HRSC2COCOTest(os.path.join(dstpath, 'test1024'), os.path.join(dstpath, 'test1024', 'HRSC_test1024.json'), wordname_15)
