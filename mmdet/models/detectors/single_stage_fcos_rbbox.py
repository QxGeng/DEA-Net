...
class SingleStageDetectorFcosRbbox(BaseDetectorNew):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(SingleStageDetectorFcosRbbox, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageDetectorFcosRbbox, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        if self.with_rbbox:
            ...
            rbbox_loss_inputs = rbbox_outs + (gt_bboxes, gt_masks, gt_labels, img_metas, self.train_cfg.retinanet)
